...
const Card: FC<CardProps> = ({ icon, title, description }) => {
  return (
    <div className="lg:w-1/3 border dark:border-stone-700 transition duration-300 shadow rounded-md cursor-default p-3 hover:shadow-stone-600/40 hover:shadow-xl flex flex-col">
