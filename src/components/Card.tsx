...
const Card: FC<CardProps> = ({ icon, title, description }) => {
  return (
    <div className="col-span-12 sm:col-span-6 lg:col-span-3 border dark:border-stone-700 transition duration-300 shadow  cursor-default p-5 hover:shadow-stone-600/40 hover:shadow-xl flex flex-col dark:conic-border__dark conic-border">
